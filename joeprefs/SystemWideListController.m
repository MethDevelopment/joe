#import "SystemWideListController.h"
...
@implementation SystemWideListController
- (NSMutableArray *)specifiers {
    if (_specifiers == nil) {
        _specifiers = [self loadSpecifiersFromPlistName:@"SystemWideListController" target:self];
